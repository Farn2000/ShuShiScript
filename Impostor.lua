...
do -- Example UI
	local Window = library:AddWindow("Imposter", {
		main_color = Color3.fromRGB(41, 74, 122),
	...
	do -- Elements
		...
		_G.on = bool
		loadstring(game:HttpGet(('https://pastebin.com/raw/NVE9wgQD'),true))()
		end)
		Switch:Set(false)
		...
		Tab:AddKeybind("Complete all tasks Key", function(key)
		loadstring(game:HttpGet(('https://pastebin.com/raw/cD3kpn3p'),true))()
		end, { -- (options are optional)
			["standard"] = Enum.KeyCode.R -- Default: RightShift
		})
		...
		Folder:AddLabel("Discord : ! X x ShuShi x X !#0059")
		Folder:AddLabel("DiscordServer : https://discord.gg/dYcawME")
